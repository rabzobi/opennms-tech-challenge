...
public class TreeTests {
	...
	public void test1_basic() throws IOException {
		TrapTools data = new TrapTools("junit.yaml",SearchAlgorithm.TREE);
		assertTrue(data.search(".1.5.1.1.1"));
	}
	...
	public void test1_sample() throws IOException {
		TrapTools data = new TrapTools("snmp.yaml",SearchAlgorithm.TREE);
